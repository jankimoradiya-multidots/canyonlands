const config = {
	...
	footerMenuLocation: 'canyonlands-menu-footer',
	siteTitle: 'Canyonlands Theme', // Will be used if we don't set site title from WordPress customizer.
	siteDescription: 'Canyonlands theme', // Will be used if we don't set site description from WordPress customizer.
